class TranslationSuggestion {
  ...
  @override
  String toString() {
    return 'TranslationSuggestion(id: $id, scientificName: $scientificName, status: $status)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is TranslationSuggestion &&
        other.id == id &&
  ...
  @override
  int get hashCode {
    return id.hashCode ^ scientificName.hashCode;
  }
}
